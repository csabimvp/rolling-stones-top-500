...
CREATE TABLE
    IF NOT EXISTS stageing.rs_master_data (
        raw_artist VARCHAR,
        description VARCHAR,
        rs_rank INTEGER,
        released_year INTEGER,
...
CREATE TABLE
    IF NOT EXISTS stageing.tracks (
        ...
        uri VARCHAR,
        released_year INTEGER
        -- album_id VARCHAR REFERENCES stageing.albums
    );

CREATE TABLE
    IF NOT EXISTS stageing.artists (
        artist_id VARCHAR PRIMARY KEY,
        artist_name VARCHAR,
        albums VARCHAR ARRAY,
        genres VARCHAR ARRAY,
...
CREATE TABLE
    IF NOT EXISTS stageing.albums (
        ...
        uri VARCHAR,
        artist_ids VARCHAR ARRAY
        -- track_id VARCHAR REFERENCES stageing.tracks,
    );

ALTER TABLE stageing.tracks ADD album_id VARCHAR REFERENCES stageing.albums;

ALTER TABLE stageing.albums ADD track_id VARCHAR REFERENCES stageing.tracks;
